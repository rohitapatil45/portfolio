    ...
    >
      ...
      <div className="absolute inset-0">
        <motion.div
          ...
          className="absolute top-20 right-20 w-96 h-96 bg-[#DC143C] rounded-full blur-3xl opacity-25"
        />
        <motion.div
          style={{ 
          ...
          className="absolute bottom-20 left-20 w-96 h-96 bg-[#DC143C] rounded-full blur-3xl opacity-25"
        />
        
        {/* Reduced floating shapes - 3 instead of 5 */}
        {[...Array(3)].map((_, i) => (
          <motion.div
            key={i}
            animate={{
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#DC143C] to-[#FF1744] relative">
                Me
                <motion.div
                  className="absolute -inset-2 bg-[#DC143C]/25 blur-2xl -z-10"
                  animate={{
                    scale: [1, 1.15, 1],
                    opacity: [0.3, 0.6, 0.3],
                  }}
          ...
          <motion.div
            ...
            style={{ boxShadow: '0 0 20px rgba(220, 20, 60, 0.6)' }}
          />
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative group">
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    {/* Gradient overlay */}
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-t from-[#DC143C]/40 via-transparent to-transparent rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-20"
                    />
          ...
          >
            ...
            {/* Optimized text animation - reduced word count */}
            <motion.p
            ...
            >
              {personalInfo.about.split(' ').map((word, i) => (
                <motion.span
                  ...
                  animate={inView ? { opacity: 1, y: 0 } : {}}
                  transition={{ delay: i * 0.02 }} // Reduced from 0.03
...
const InfoCard = React.memo(({ card, inView }) => (
  ...
  >
    ...
    <motion.div
      ...
      style={{
        background:
          'linear-gradient(90deg, transparent, rgba(220, 20, 60, 0.25), transparent)',
      }}
      animate={{
        x: ['-100%', '100%'],
      }}
    ...
    <div className="flex items-start gap-4 relative z-10">
      <motion.div
        className="p-4 bg-gradient-to-br from-[#DC143C]/25 to-[#DC143C]/5 rounded-xl"
...
const TiltCard = React.memo(({ children }) => {
  ...
  const handleMouseMove = useCallback((e) => {
    ...
    const x = (clientY - top - height / 2) / 25; // Reduced from 20
...
const CountUp = React.memo(({ value, suffix }) => {
  const [count, setCount] = React.useState(0);

  React.useEffect(() => {
    let start = 0;
    const duration = 1500; // Reduced from 2000
    const increment = value / (duration / 20); // Increased interval from 16 to 20
